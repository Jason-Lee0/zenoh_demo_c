...
const char *expr = "device_command/123";
const char *value = "OK";
z_keyexpr_t keyexpr;
...
void query_handler(const z_query_t *query, void *context) {
    ...
    z_query_reply(query, z_keyexpr((const char *)context), (const char *)value, strlen(value), &options);
